...
export default function AboutCart() {
  ...
  const [text] = useTypewriter({
    words: ["I'm a Web Developer, with knowledge of HTML, CSS, Javascript, Node Js,React Js, Next Js and MongoDB, I can make all kinds of static anddynamic web pages for any kind of clients."],
    loop: {},
    typeSpeed: 120,
    deleteSpeed: 100,
  });
  return (
    <main>
      ...
      <p className="text-gray-500 my-4 text-md lg:text-xl">
      ...
      <div className="flex flex-col lg:flex-row gap-y-2 lg:gap-7 my-8">
        ...
        <div className="lg:mx-2 my-6 lg:my-0 ">
          ...
          <div className="flex flex-col lg:flex-row lg:gap-x-10 my-2 text-gray-500 text-xl">
            <ul className="text-sm lg:text-sm">
              <li className="flex gap-3 mt-4">
                <AiOutlineRight className="text-sky-400 lg:text-sm" />
