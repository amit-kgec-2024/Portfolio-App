    ...
    <main className=" ld:w-[80%] lg:pl-[20%] relative" id="contact">
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row gap-2 mx-10 md:mx-28">
          <ul className=" md:mx-16 my-6 md:w-[80%] lg:w-[50%">
            <h1 className="text-center text-2xl text-teal-800 my-6 font-bold">
              <span>Get in Touch</span>
            </h1>
            <li className="flex flex-row gap-4 text-gray-500 text-md lg:text-xl my-3">
              <FaUser className="my-4 text-2xl lg:text-4xl text-red-700" />
              <div>
                <h1>Name</h1>
                <h2>Amit Mandal</h2>
              </div>
            ...
            <li className="flex flex-row gap-4 text-gray-500 text-md lg:text-xl my-3">
              <IoIosMail className="my-4 text-2xl lg:text-4xl text-red-700" />
              <div>
                <h1>Gmail</h1>
            ...
            <li className="flex flex-row gap-4 text-gray-500 text-md lg:text-xl my-3">
              <FaLocationDot className="my-4 text-2xl lg:text-4xl text-red-700" />
              <div>
                <h1>Addres</h1>
            ...
            <li className="flex flex-row gap-4 text-gray-500 text-md lg:text-xl my-3">
              <IoCall className="my-4 text-2xl lg:text-4xl text-red-700" />
              <div>
                <h1>Mobil Number</h1>
                <h2>+918513089660</h2>
              </div>
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500"
            ...
            <div className="text-center">
              <button
                type="submit"
                value="send"
                className="border border-spacing-3 transition duration-300 p-3 mt-10 text-xs lg:text-xl rounded-md bg-red-700 hover:bg-red-600 text-white hover:text-sky-100"
              >
                Send message
              </button>
            </div>
