import React from 'react'
 ...
 export default function SkillsCart() {
   return (
     <div className="flex flex-col lg:flex-row">
       <div className='w-full'>
         <div className="container p-4 my-4 gap-0 flex flex-col lg:text-2xl">
           ...
           <ul className=" h-2 bg-blue-200 w-full rounded-md">
         ...
         <div className="container p-4 my-4 gap-0 flex flex-col lg:text-2xl">
           ...
           <ul className=" h-2 bg-blue-200 w-full rounded-md">
             <li className="bg-accent h-2 w-[50%] top-0 rounded-md" />
           </ul>
         </div>
       </div>
       ...
       <div className='w-full'>
         ...
         <div className="container p-4 my-4 gap-0 flex flex-col lg:text-2xl">
           ...
           <ul className=" h-2 bg-blue-200 w-full rounded-md">
             <li className="bg-accent h-2 w-[30%] top-0 rounded-md" />
           </ul>
         </div>
       </div>
     </div>
